...
def custom_site_command(message):
    try:
        ...
        send_safe(message.chat.id, "❌ Error setting custom site")
...
def remove_site_command(message):
    try:
        ...
        send_safe(message.chat.id, "❌ Error removing site")
...
def check_current_site(message):
    try:
        ...
        send_safe(message.chat.id, "❌ Error checking site")
...
def broadcast_command(message):
    ...
    try:
        ...
        send_safe(message.chat.id, "❌ Error broadcasting")
...
def send_help(message):
    try:
        ...
        send_safe(message.chat.id, "❌ Error showing help")
